...
public class lexical{
	...
	lexical(){
		regs.add(new regExpression(4,"EXP"));
		regs.add(new regExpression(5,"E"));
		regs.add(new regExpression(6,"BINARY"));
		regs.add(new regExpression(7,"B"));
		regs.add(new regExpression(1,"1"));
		regs.add(new regExpression(2,"0"));
		regs.add(new regExpression(3,"\\."));
	}
